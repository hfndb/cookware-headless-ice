...
exports.searchProject = exports.renderSysTemplate = exports.backupChangedSource = exports.getStamp = exports.generateWeb = exports.Colors = void 0;
...
class Colors {
    static getConfig() {
        let path = path_1.join(cfg.dirProject, "dev", "colors.json");
        let go = shelljs_1.test("-f", path_1.join(path));
        return go ? lib_1.FileUtils.readJsonFile(path) : null;
    }
    static generate() {
...
function generateWeb(verbose) {
    ...
    if (shelljs_1.test("-d", dir)) {
        ...
        log.info(`Path ./${cfg.options.html.dirs.content} doesn't exist. Request to render ignored`);
    }
}

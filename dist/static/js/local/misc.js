...
exports.searchProject = exports.backupChangedSource = exports.generateWeb = void 0;
...
function generateColorFiles() {
    ...
    if (!needsWrite) {
        needsWrite = lib_1.FileUtils.readFile(fullPath) != sass.content;
    }
    if (needsWrite) {
    ...
    needsWrite = !shelljs_1.test("-f", fullPath);
    if (!needsWrite) {
        needsWrite = lib_1.FileUtils.readFile(fullPath) != src.content;
    }
    if (needsWrite) {

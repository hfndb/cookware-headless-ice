...
class AppConfig {
  ...
  static getProjectDir(dir) {
    while (dir.length > 2 && !(0, _shelljs.test)("-f", (0, _path.join)(dir, "settings.json"))) {
  ...
  read() {
    let defaults = JSON.stringify(_defaultSettings.DefaultConfig);
    ...
    let settings = (0, _path.join)(this.dirProject, "settings.json");

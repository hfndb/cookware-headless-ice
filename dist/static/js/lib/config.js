...
class AppConfig {
  ...
  read() {
    this.options = Object.assign({}, _defaultConfig.DefaultConfig);
  ...
  static showConfig(options = null) {
    ...
    if (!options) options = Object.assign({}, _defaultConfig.DefaultConfig);

    let project = _files.FileUtils.readJsonFile((0, _path.join)(cfg.dirProject, "config.json"), false);

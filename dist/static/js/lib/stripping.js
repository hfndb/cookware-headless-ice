...
exports.Stripper = exports.Shrinker = void 0;
...
class Shrinker {
  ...
  static init() {
    ...
    if (!Shrinker.cfg) {
      path = (0, _path.join)(cfg.dirProject, "dev", "shrink.json");
      Shrinker.cfg = (0, _shelljs.test)("-f", (0, _path.join)(path)) ? _lib.FileUtils.readJsonFile(path) : null;
    }
  }
...
_defineProperty(Shrinker, "cfg", void 0);

...
function renderSysTemplate(res, path, context) {
  ...
  let entry = new _fileDiff.FileStatus((0, _path.join)(cfg.dirMain, "content"));
...
async function controllerGeneric(req, res, next, dir, prefix) {
  ...
  if (prefix == "/sys" && ext == ".html") {
    dir = (0, _path.join)(cfg.dirMain, "content");
  }

  if (!(0, _shelljs.test)("-e", (0, _path.join)(dir, url))) {
    next();
    return;
  }
  ...
  switch (ext) {
    case ".md":
      let md = (0, _markdown.renderMarkdownFile)(dir, url);
      additionalContext = Object.assign(additionalContext, {
        extractedTitle: md[1],
        rendered: md[0]
      });
    ...
    case ".html":
      ...
      if (ext != ".md" && req.query && req.query.lint) {
        ...
        entry = new _fileDiff.FileStatus(dir);

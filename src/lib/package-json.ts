...
export class Packages {
	 ...
	 */
	static getPackages(dir: string): string[] {
	 ...
	 * Used in UI of dev server
	 */
	static getPackageReadmeFiles(sys: boolean): object[] {
	 ...
	 */
	static isOlder(ref: string, val: string) {
		/*
		...
		*/
		...
		let vrsRef: any = ref.split(".");
		let vrsVal: any = val.split(".");
	 ...
	 */
	static updatePackages(sys: boolean) {
		let cfg = AppConfig.getInstance();
		let dir = sys ? cfg.dirMain : cfg.dirProject;
